<template>
    <div class="h-screen flex justify-center bg-slate-200">
        ...
        <div class="bg-slate-50 rounded-md p-11 xl:w-4/12 lg:w-5/12 sm:w-6/12">
            ...
            <h1 class="text-sm text-slate-400 mt-1 flex justify-center">Please input your email and password</h1>
        ...
        <div class="justify-center grid">
            <h1 class="text-sm">Dont have an account ?</h1>
            <button @click="$router.push('/')" class="text-sm text-indigo-600 hover:text-indigo-700">Register </button>
        </div>
        </div>
    </div>
  </template>
